...
#define DUNE_IMC_CONST_GIT_INFO "2014-09-18 550440c  (HEAD, tag: imc-5.4.3, origin/master, origin/HEAD, master, feature/turbidity)"
//! MD5 sum of XML specification file.
#define DUNE_IMC_CONST_MD5 "2082508f7ca90365a9b479251a12d1d7"
